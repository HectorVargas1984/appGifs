export interface SearchGIFResponce {
  data: Gif[];
...
export class Convert {
  public static toSearchGIFResponce(json: string): SearchGIFResponce {
    return cast(JSON.parse(json), r('SearchGIFResponce'));
  }

  public static searchGIFResponceToJson(value: SearchGIFResponce): string {
    return JSON.stringify(uncast(value, r('SearchGIFResponce')), null, 2);
  }
}
